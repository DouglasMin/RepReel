...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    POST /reels
    Ingests Instagram Reel URL, checks authorization, initializes Job in DynamoDB, and enqueues to SQS.
    ...
    try:
        ...
        if not url or ("instagram.com" not in url):
            return {
                "statusCode": 400,
                "headers": {"Content-Type": "application/json"},
                "body": json.dumps({"error": "Invalid or missing 'url' parameter. Must be an Instagram Reel URL."}),
            }
        ...
        response_body = {
            ...
            "reel_id": reel_id,
            "status": "PROCESSING",
            "message": "Reel analysis job initiated successfully.",
